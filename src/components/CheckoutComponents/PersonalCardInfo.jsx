...
const PersonalCardInfo = props => {
  ...
  return (
    <div className="lg:w-3/5 w-full lg:pl-28 lg:pr-20 px-8 lg:border-r-[2px] border-blackV">
      {/* CARD INFORMATION */}
      <div>
        <h1 className="uppercase pb-1 font-semibold  mb-6 text-xl pr-4">Checkout</h1>
        <div className="w-full md:border-0 border-b border-blackV mb-6">
          <h2 className="pb-1 md:border-b-[2px] border-blackV inline-block font-medium text-lg pr-4">PERSONAL INFORMATION</h2>
        </div>

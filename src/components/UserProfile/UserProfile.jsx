  ...
  return (
    <Layout>
      ...
      <div className="flex justify-center mx-56 relative">
        ...
        <div className="h-96 w-8/12 relative">
          {/* Main title */}
          <div>
          ...
          {personalInfoFields.map((field, index) => (
            <div key={field.label} className="flex items-center justify-center ml-20 mb-5">
              <h2 className="uppercase font-medium w-1/4 text-lg mr-0">{field.label} :</h2>
          ...
          <div className="flex flex-1 justify-end pr-[7.8rem]">
            <BtnGlobal content="Save Changes" className="border px-5 py-2 bg-blackV hover:bg-black hover:bg-opacity-90 hover:border-white text-white" />
          </div>
        </div>

        {/* Change Picture Section */}
        <div className=" h-96 w-4/12 flex justify-center items-center flex-col">
          <h1 className="uppercase text-2xl text-black mb-4">Change picture section</h1>

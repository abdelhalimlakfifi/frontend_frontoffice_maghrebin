  ...
  return (
    <div className=" w-full h-full">
      ...
      <div className="flex flex-col mb-11 h-full w-full">
        <div className="mx-11 md:mx-11 lg:mx-52 xl:mx-80 flex justify-between h-[25rem] md:h-[35rem] lg:h-[45rem] ">
          <div className=" relative w-[15rem] md:w-[20rem] lg:w-[30rem] xl:w-[38rem]">
            <img
        ...
        <div className="mx-11 mt-11 lg:mt-20 md:mx-11 lg:mx-52 xl:mx-80 flex justify-between h-[25rem] md:h-[35rem] lg:h-[45rem] ">
          <div className=" relative w-[15rem]  md:w-[20rem] lg:w-[30rem] xl:w-[38rem] ">
            <img
              className="w-full h-full object-cover hover:opacity-90 transition-opacity duration-300 ease-in-out cursor-pointer"
              src={wedding}

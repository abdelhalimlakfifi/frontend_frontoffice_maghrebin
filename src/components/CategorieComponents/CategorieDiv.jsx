...
const CategorieDiv = ({ imgSrc }) => {
  return (
    <div className="w-1/3 border-r border-2 border-blackV relative">
      ...
      <BtnGlobal
        className="absolute bottom-10 border-2 left-1/2 p-2 w-28 md:p-4 md:w-44  lg:p-5 lg:w-52 transform -translate-x-1/2 bg-white hover:bg-purple-400 border-blackV hover:border-white hover:text-white  font-medium text-lg "
        content="View More"
      />
    </div>
  );

...
const Card = ({ id, title, price, mainImg, secondaryImg }) => {
  ...
  return (
    <div className="flex flex-col   lg:w-[13rem] xl:w-[17rem]">
      <div
        className="relative"
      ...
      <div className="justify-between my-2 text-sm md:text-base  font-medium">
      ...
      <div className="">
        ...
        <div className="flex justify-center gap-2 md:gap-5">
          <BtnGlobal className="lg:hidden w-1/2 border-2 border-blackV bg-blackV text-white text-base md:text-xl p-1 md:p-2 my-2 pi pi-shopping-bag rounded-sm" />
          <BtnGlobal

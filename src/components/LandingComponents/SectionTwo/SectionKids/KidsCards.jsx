...
const MenCards = () => {
  ...
  const cardData = [
    { title: "Product 1", price: "20.00$", imageSrc: BoyKid1 },
    { title: "Product 2", price: "25.00$", imageSrc: BoyKid1 },
    { title: "Product 3", price: "30.00$", imageSrc: BoyKid1 },
    { title: "Product 4", price: "20.00$", imageSrc: BoyKid1 },
  ];
